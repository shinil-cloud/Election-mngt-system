...
<!--===============================================================================================-->
	...
	<link rel="stylesheet" type="text/css" href="<?php echo base_url();?>assetsAdmin/css/public/main.css">
		<link rel="stylesheet" type="text/css" href="<?php echo base_url();?>assetsAdmin/css/custom.css">
			<link rel="stylesheet" type="text/css" href="<?php echo base_url();?>assetsAdmin/css/public/table/candidate.css">
<!--===============================================================================================-->
  
  
  
  
  <title>Admin Dashboard : Candidates list</title>
...
<body class="app header-fixed sidebar-fixed aside-menu-fixed aside-menu-hidden">
  ...
  <div class="app-body">
	...
	<main class="main">
		...
		<div class="limiter">
		<div class="ab"><p class="font1" align="left"><font size="300px">Candidates list</font></p>
					
                </div>
				<div class="text-center">
					<button class="btn btn-success" onClick="addData();"><i class="glyphicon glyphicon-plus"></i> Add Candidate</button>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title"><strong>Add Candidate</strong></h3>
            ...
            <div class="modal-body form">
                <form action="#" id="form" class="form-horizontal" enctype="multipart/form-data">
                    ...
                    <div class="form-body">
						...
						-->
                        <div class="form-group">
                            <label for="Candidate_Id" class="control-label col-md-3">Candidate Id*</label>
                            <div class="col-md-9">
                                <input name="Candidate_Id" id="Candidate_Id" placeholder="Candidate Id" class="form-control" required type="text">
                                <span class="help-block"></span>
                            </div>
                        </div>
						<div class="form-group">
                            <label for="Candidate_Name" class="control-label col-md-3">Candidate Name*</label>
                            <div class="col-md-9">
                                <input name="Candidate_Name" id="Candidate_Name" placeholder="Candidate Name" class="form-control" required type="text">
                                <span class="help-block"></span>
                            </div>
                        </div>
						<div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="DOB" id="DOB" placeholder="Date of Birth" class="form-control" required type="date">
                                <span class="help-block"></span>
                            </div>
                        </div>
								<!--
						<div class="form-group">
                            <label for="Voters_Count" class="control-label col-md-3">*</label>
                            <div class="col-md-9">
                        ...
                        <div class="form-group">
                            <label for="Party_Name" class="control-label col-md-3">Party Name*</label>
                            <div class="col-md-9">
                                <input id="Party_Name" name="Party_Name"  placeholder="Party Name" class="form-control required" required type="text">
                                <span class="help-block"></span>
                            </div>
                        </div>
                        
                        <div class="form-group">
                            <label for="Symbol" class="control-label col-md-3">Symbol*</label>
                            <div class="col-md-9">
                                <input id="Symbol" name="Symbol"  placeholder="Symbol" class="form-control required" required type="text">
                                <span class="help-block"></span>
                            </div>
                        </div>
                      		<!--	
...
<!-- End Bootstrap modal -->
   ...
   <script type="text/javascript" src="<?php echo base_url();?>assetsAdmin/js/admin/candidates.js"></script>
