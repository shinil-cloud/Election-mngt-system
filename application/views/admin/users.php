...
<link rel="stylesheet" type="text/css" href="<?php echo base_url();?>assetsAdmin/css/public/table/users.css">
<!--===============================================================================================-->
...
<body class="app header-fixed sidebar-fixed aside-menu-fixed aside-menu-hidden">
  ...
  <div class="app-body">
	...
	<main class="main">
		...
		<div class="limiter">
		<div class="ab"><p class="font1" align="left"><font size="300px">Users list</font></p>
                ...
                <form action="#" id="form" class="form-horizontal" enctype="multipart/form-data">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="User_Id" id="User_Id" placeholder="User Id" class="form-control" required type="text">
...
<!-- End Bootstrap modal -->
   ...
   <script type="text/javascript" src="<?php echo base_url();?>assetsAdmin/js/admin/users.js"></script>
