...
<link rel="stylesheet" type="text/css" href="<?php echo base_url();?>assetsAdmin/css/public/table/booth.css">
<!--===============================================================================================-->
			...
			<div class="ab"><p class="font1" align="left"><font size="300px">Booths list</font></p>
				...
				<div class="table100">
					<table id="dataTable">
						<thead>
							<tr class="table100-head">
								<th class="text-center">Booth ID</th>
						<th>Polling Count</th>
						<th>Created On</th>
						<th>Status</th>
					    <th>Action</th>
            ...
            <div class="modal-body form">
                <form action="#" id="form" class="form-horizontal" enctype="multipart/form-data">
                    ...
                    <div class="form-body">
						...
						<!--
						<div class="form-group">
                            <label for="Voters_Count" class="control-label col-md-3">Polling Count</label>
                            <div class="col-md-9">
