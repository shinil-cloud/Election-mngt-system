...
<link rel="stylesheet" type="text/css" href="<?php echo base_url();?>assetsAdmin/css/public/table/schedule.css">
<!--===============================================================================================-->
  ...
  <title>Admin Dashboard : Schedule Election</title>
...
<body class="app header-fixed sidebar-fixed aside-menu-fixed aside-menu-hidden">
  ...
  <div class="app-body">
	...
	<main class="main">
		...
		<div class="limiter">
		<div class="ab"><p class="font1" align="left"><font size="300px">Schedule Election</font></p>
					
                </div>
				
     
				<div class="text-center">
					<button class="btn btn-success" onClick="addData();"><i class="glyphicon glyphicon-plus"></i> Add Schedule</button>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title"><strong>Add Schedule</strong></h3>
            ...
            <div class="modal-body form">
				...
				-->
						<div class="form-group">
                            <label for="Schedule_Id" class="control-label col-md-3">Schedule ID</label>
                            <div class="col-md-9">
                                <input name="Schedule_Id" id="Schedule_Id" placeholder="Schedule Id" class="form-control" required type="text">
                                <span class="help-block"></span>
                            </div>
                        </div>	
						<div class="form-group">
                            <label for="Election_Name" class="control-label col-md-3">Election Name</label>
                            <div class="col-md-9">
                                <input name="Election_Name" id="Election_Name" placeholder="Election Name" class="form-control" required type="text">
                                <span class="help-block"></span>
                            </div>
                        </div>							
                        <div class="form-group">
                            <label for="Election_Date" class="control-label col-md-3">Election Date</label>
                            <div class="col-md-9">
                                <input name="Election_Date" id="Election_Date" placeholder="Election Date" class="form-control" required type="date">
                                <span class="help-block"></span>
                            </div>
                        </div>
						<div class="form-group">
                            <label for="Start_Time" class="control-label col-md-3">Start Time</label>
                            <div class="col-md-9">
                                <input name="Start_Time" id="Start_Time" placeholder="Start Time" class="form-control" required type="time">
                                <span class="help-block"></span>
                            </div>
                        </div>
						<div class="form-group">
                            <label for="End_Time" class="control-label col-md-3">End Time</label>
                            <div class="col-md-9">
                                <input name="End_Time" id="End_Time" placeholder="End Time" class="form-control" required type="time">
                                <span class="help-block"></span>
                            </div>
                        </div>
						<!--
...
<!-- End Bootstrap modal -->
   ...
   <script type="text/javascript" src="<?php echo base_url();?>assetsAdmin/js/admin/schedule.js"></script>
