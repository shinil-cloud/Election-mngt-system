...
class UserModel extends CI_Model{
	...
	var $column_order = array('','UserId','LastLoginDate','CreatedOn','Status'); //set column field database for datatable orderable
	var $column_search = array('UserId', 'Status'); //set column field database for datatable searchable.
