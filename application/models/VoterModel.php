...
class VoterModel extends CI_Model{
	...
	var $column_order = array('','VoterId','AadharId','VoterName','DOB','Address','Gender','BoothId','Eligibility'); //set column field database for datatable orderable
	var $column_search = array('VoterId'); //set column field database for datatable searchable.
 ...
 private function getDataTableQuery()
	{
	   ...
	   // $this->db->where('BoothId=', $_SESSION['BOOTH_ID']);
		$i = 0;
