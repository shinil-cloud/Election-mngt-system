...
class StaffModel extends CI_Model{
	...
	var $column_order = array('','StaffID','AadharID','StaffName','DOB','Address','Gender','BoothID','MobNo'); //set column field database for datatable orderable
	var $column_search = array('StaffId'); //set column field database for datatable searchable.
