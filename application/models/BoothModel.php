...
class BoothModel extends CI_Model{
	...
	var $column_order = array('','BoothId','AdminName','PollingCount','LastLoginDate','CreatedOn','Status'); //set column field database for datatable orderable
	var $column_search = array('BoothId'); //set column field database for datatable searchable.
