...
class ScheduleModel extends CI_Model{
	...
	var $table = 'voting_config';
	
	
	var $column_order = array('','ScheduleId','ElectionName','ElectionDate','StartTime','EndTime'); //set column field database for datatable orderable
