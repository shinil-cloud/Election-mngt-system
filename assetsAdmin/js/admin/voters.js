...
var save_method; //for save method string
    ...
    table = $('#dataTable').DataTable({ 
        ...
        "ajax": {
            "url": base_url + "index.php/admin/voterList", //<?php echo site_url('person/ajax_list')?>
   ...
   function addData()
    ...
    $('.hideWhenEdit input').removeClass('optional');
	$('#hidID').val("0");
	$("#divError").hide();
    $("#divMessage").hide();
  ...
  function save()
  {
	    ...
	    var url = base_url + "index.php/admin/saveVoter";
   ...
   function editData(id)
{
	...
	var url = base_url + "index.php/admin/getEditVoter";
    ...
    $('.hideWhenEdit input').addClass('optional');
    ...
    $.ajax({
        ...
        success: function(data)
        {
            ...
            $("#id").val(data.Id);
			$("#hidID").val(data.Id);
			$("#Voter_Id").val(data.VoterId);
			$("#Aadhar_Id").val(data.AadharId);
			$("#Voter_Name").val(data.VoterName);
			$("#DOB").val(data.DOB);
			$("#Address").val(data.Address);
			$("#Gender").val(data.Gender);
			$("#Booth_Id").val(data.BoothId);
		...
		//	$("#Email").val(data.Email);
           ...
           // $("#Status").val(data.Status);
            ...
            $('.modal-title').text('Edit Voter Details'); // Set title to Bootstrap modal title
...
function revokeVoter(id)
	{
	 bootbox.confirm("Are you sure to revoke this person?", function(result) {
		 if(result)
		{
        // ajax delete data to database
		var url = base_url + "index.php/admin/revokeVoter/" + id;
        $.ajax({
            url : url,
            type: "POST",
            dataType: "text",
  ...
  function deleteData(id)
{
	...
	{
        // ajax delete data to database
		var url = base_url + "index.php/admin/deleteVoter/" + id;
        $.ajax({
            url : url,
            type: "POST",
            dataType: "text",
