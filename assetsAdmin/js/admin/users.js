...
var save_method; //for save method string
    ...
    table = $('#dataTable').DataTable({ 
        ...
        "ajax": {
            "url": base_url + "index.php/admin/userList", //<?php echo site_url('person/ajax_list')?>
            "type": "POST"
  ...
  function save()
  {
	    ...
	    var url = base_url + "index.php/admin/saveUser";
   ...
   function editData(id)
{
	...
	var url = base_url + "index.php/admin/getEditUser";
  ...
  function deleteData(id)
{
     ...
     if(result)
	{
		...
		var url = base_url + "index.php/admin/deleteUser/" + id;
        $.ajax({
            url : url,
            type: "POST",
            dataType: "text",
