...
var save_method; //for save method string
    ...
    table = $('#dataTable').DataTable({ 
        ...
        "ajax": {
            "url": base_url + "index.php/admin/staffList", //<?php echo site_url('person/ajax_list')?>
            "type": "POST"
  ...
  function save()
  {
	    ...
	    var url = base_url + "index.php/admin/saveStaff";
 ...
 if (typeof FormData == 'undefined')
  {
      ...
      return false;
        ...
        /*  
         formData.append('StaffID', $("#Staff_Id").val());
    //     formData.append('userfile', fileField.files[0]); 
    
            //formData.append('userfile', $("#userfile").val());
         formData.append('AadharID', $("#Aadhar_Id").val());
		 formData.append('StaffName', $("#Staff_Name").val());
         formData.append('DOB', $("#DOB").val());
         formData.append('Address', $("#Address").val());
		 formData.append('Gender',$("#Gender").val());
		 formData.append('hidID', $("#hidID").val()); // for save or edit.
          formData.append('BoothID',$("#Gender").val());
		   formData.append('Gender',$("#Gender").val());*/
   ...
   function editData(id)
{
	...
	var url = base_url + "index.php/admin/getEditStaff";
  ...
  function deleteData(id)
{
     ...
     if(result)
	{
		...
		var url = base_url + "index.php/admin/deleteStaff/" + id;
        $.ajax({
            url : url,
            type: "POST",
            dataType: "text",
