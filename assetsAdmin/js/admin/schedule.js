...
var save_method; //for save method string
    ...
    table = $('#dataTable').DataTable({ 
        ...
        "ajax": {
            "url": base_url + "index.php/admin/scheduleList", //<?php echo site_url('person/ajax_list')?>
            "type": "POST"
  ...
  function save()
  {
	    ...
	    var url = base_url + "index.php/admin/saveSchedule";
   ...
   function editData(id)
{
	...
	var url = base_url + "index.php/admin/getEditSchedule";
    ...
    $.ajax({
        ...
        success: function(data)
        {
			...
			$("#Election_Name").val(data.ElectionName);
			$("#Election_Date").val(data.ElectionDate);
  ...
  function deleteData(id)
{
     ...
     if(result)
	{
		...
		var url = base_url + "index.php/admin/deleteSchedule/" + id;
        $.ajax({
            url : url,
            type: "POST",
            dataType: "text",
