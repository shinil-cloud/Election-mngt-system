...
var save_method; //for save method string
    ...
    table = $('#dataTable').DataTable({ 
        ...
        "ajax": {
            "url": base_url + "index.php/admin/boothList", //<?php echo site_url('person/ajax_list')?>
            "type": "POST"
  ...
  function save()
  {
	    ...
	    var url = base_url + "index.php/admin/saveBooth";
   ...
   function editData(id)
{
	...
	var url = base_url + "index.php/admin/getEditBooth";
    ...
    $.ajax({
        ...
        success: function(data)
        {
			...
			//$("#Voters_Count").val(data.VotersCount);
		...
		//	$("#Sex").val(data.Sex);
            ...
            $('.modal-title').text('Edit Booth Details'); // Set title to Bootstrap modal title
  ...
  function deleteData(id)
{
     ...
     if(result)
	{
		...
		var url = base_url + "index.php/admin/deleteBooth/" + id;
        $.ajax({
            url : url,
            type: "POST",
            dataType: "text",
