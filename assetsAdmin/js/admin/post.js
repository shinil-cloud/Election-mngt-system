...
var save_method; //for save method string
    ...
    table = $('#dataTable').DataTable({ 
        ...
        "ajax": {
            "url": base_url + "index.php/admin/postsList", //<?php echo site_url('person/ajax_list')?>
            "type": "POST"
  ...
  function reloadTable()
{
  ...
  function save()
  {
	    ...
	    var url = base_url + "index.php/admin/savePost";
...
function editData(id)
{
	...
	var url = base_url + "index.php/admin/getEditPost";
 ...
 function deleteData(id)
{
     ...
     if(result)
	{
		...
		var url = base_url + "index.php/admin/deletePost/" + id;
        $.ajax({
            url : url,
            type: "POST",
            dataType: "text",
