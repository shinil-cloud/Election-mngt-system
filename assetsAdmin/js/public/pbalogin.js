 ...
 $("#btnLogin").text("Login");
	...
	$("#btnLogin").click(function(){
	   ...
	   if(boothid=="" || boothid==null)
	  {
		...
		//Ajax submit start 
	    $.ajax({
		url : base_url+ "pba/adminLoginCheck",
		type: "POST",
		...
		success: function(response)
		{
			...
			var URL = base_url + "pba/adminhome";
  ...
  function save()
  {
	    ...
	    var url = base_url + "index.php/pba/changeAdminPassword";
 ...
 if (typeof FormData == 'undefined')
  {
   ...
   $("#btnResetPass").click(function(){
		...
		var url = base_url + "index.php/pba/resetAdminPassword" ;
        $.ajax({
            url : url,
            type: "POST",
            dataType: "json",
